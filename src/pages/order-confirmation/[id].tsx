...
const OrderConfirmationPage = () => {
  ...
  // Get user's address from context
    ...
    if (id) {
      ...
      if (modelData) {
        ...
        const mockOrderDetails = {
          ...
          paymentId:
            orderId || `pay_${Math.random().toString(36).substring(2, 15)}`,
  ...
  if (!model || !orderDetails)
    return (
      <div className="container mx-auto px-4 py-8">Order details not found</div>
    );
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-green-50 rounded-lg p-6 mb-8 text-center">
            ...
            <p className="text-green-700">
              ...
              start processing your print immediately.
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Your model is now in our production queue. We'll start
                    printing it shortly.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Once printed, your model will undergo a thorough quality
                    check.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    After quality approval, your model will be carefully
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    You'll receive your model at the provided address. We'll
                    send you tracking information once it's shipped.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            ...
            <p>
              Contact us at{" "}
              <a
                href="mailto:support@innoprint.com"
                className="text-blue-500 hover:underline"
              >
                support@innoprint.com
              </a>{" "}
              or call{" "}
              <a
