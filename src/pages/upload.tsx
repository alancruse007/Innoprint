...
const Upload = () => {
  ...
  return (
    <>
      <Head>
        <title>Upload Model | Innoprint</title>
        <meta name="description" content="Upload your 3D model for printing" />
      </Head>

      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center mb-8">Upload model</h1>

        <div className="max-w-3xl mx-auto">
          {/* File Upload Area */}
          <div 
            className={`border-2 border-dashed rounded-lg p-12 flex flex-col items-center justify-center h-64 ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-gray-300'}`}
            ...
            {uploading ? (
              ...
              <>
                ...
                <p className="mb-2 text-sm text-gray-500">
                  <span className="font-semibold">Drag & drop</span> or click to choose files
                </p>
                <input 
                  id="file-upload" 
                  type="file" 
          ...
          <div className="mt-8 flex space-x-4">
            <button
              ...
              className={`flex-1 py-3 rounded-md ${!file || uploading ? 'bg-gray-300 cursor-not-allowed' : 'bg-blue-500 hover:bg-blue-600'} text-white transition-colors`}
            >
              Submit
            </button>
            <Link 
